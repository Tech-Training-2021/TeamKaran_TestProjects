...
using VoIP_CustomerPortal.Application.Contracts.Identity;
using VoIP_CustomerPortal.Application.Models.Authentication;
using VoIP_CustomerPortal.Identity.Models;

namespace VoIP_CustomerPortal.Identity.Services
{
